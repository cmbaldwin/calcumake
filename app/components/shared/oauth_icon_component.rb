...
module Shared
  ...
  class OAuthIconComponent < ViewComponent::Base
    ...
    def yahoo_japan_svg
      tag.svg(**html_attrs, viewBox: "0 0 24 24", fill: "#FF0033", class: css_classes) do
        tag.path(nil, d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-1.5-4L7 17H5.5l2-5.5L5.5 7H7l1.5 4L10 7h1.5l-2 4.5L11.5 17H10zm7-6h-1v6h-1.5v-6H14V9.5h3V11z")
      end
    end
