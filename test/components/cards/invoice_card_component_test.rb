...
class Cards::InvoiceCardComponentTest < ViewComponent::TestCase
  ...
  test "renders invoice card" do
    render_inline(Cards::InvoiceCardComponent.new(invoice: @invoice))
  ...
  test "accepts custom html_options classes" do
    render_inline(Cards::InvoiceCardComponent.new(invoice: @invoice, html_options: { class: "custom-class" }))
