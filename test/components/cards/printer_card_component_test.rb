...
class Cards::PrinterCardComponentTest < ViewComponent::TestCase
  ...
  test "renders printer card" do
    render_inline(Cards::PrinterCardComponent.new(printer: @printer, current_user: @user))
  ...
  test "accepts custom html_options classes" do
    render_inline(Cards::PrinterCardComponent.new(printer: @printer, current_user: @user, html_options: { class: "custom-class" }))
