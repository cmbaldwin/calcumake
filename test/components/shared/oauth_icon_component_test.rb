...
module Shared
  class OAuthIconComponentTest < ViewComponent::TestCase
    test "renders Google icon" do
      render_inline(OAuthIconComponent.new(provider: :google))
    ...
    test "renders GitHub icon" do
      render_inline(OAuthIconComponent.new(provider: :github))
    ...
    test "renders Microsoft icon" do
      render_inline(OAuthIconComponent.new(provider: :microsoft))
    ...
    test "renders Facebook icon" do
      render_inline(OAuthIconComponent.new(provider: :facebook))
    ...
    test "renders Yahoo Japan icon" do
      render_inline(OAuthIconComponent.new(provider: :yahoojp))
    ...
    test "renders LINE icon" do
      render_inline(OAuthIconComponent.new(provider: :line))
    ...
    test "handles provider name variations" do
      render_inline(OAuthIconComponent.new(provider: "yahoo japan"))

      assert_selector "svg[fill='#FF0033']"
    end

    test "returns empty string for unknown provider" do
      render_inline(OAuthIconComponent.new(provider: :unknown))
    ...
    test "merges custom CSS classes" do
      render_inline(OAuthIconComponent.new(provider: :google, html_options: { class: "custom-class" }))
