...
class OauthButtonsViewTest < ActionView::TestCase
  test "renders OAuth buttons partial with all provider buttons" do
    ...
    # Test that all five provider buttons are rendered
    assert_select ".col-12", 5
  ...
  test "OAuth buttons have correct CSS classes" do
    ...
    assert_select "a.w-100.d-flex.align-items-center.justify-content-center", 5
  end
  ...
  test "OAuth buttons have correct accessibility attributes" do
    ...
    assert_select "a[role='button']", 5
    assert_select "a[aria-label]", 5

    # Test tooltip attributes
    assert_select "a[data-bs-toggle='tooltip']", 5
    assert_select "a[data-bs-placement='top']", 5
    assert_select "a[data-bs-title]", 5
  end
  ...
  test "OAuth buttons use POST method" do
    ...
    assert_select "a[data-method='post']", 5
  end
  ...
  test "OAuth buttons include provider icons" do
    ...
    assert_select "svg[width='18'][height='18']", 5
    assert_select "svg.me-2", 5
    assert_select "svg[aria-hidden='true']", 5
  end
  ...
  test "OAuth buttons maintain Bootstrap 5 compatibility" do
    ...
    assert_select ".col-12", 5   # Bootstrap 5 grid system
    assert_select ".d-flex.align-items-center.justify-content-center", 5  # Bootstrap 5 flexbox utilities
  ...
  test "OAuth buttons work with all supported authentication providers" do
    ...
    # Test that we have buttons for all 5 OAuth providers
