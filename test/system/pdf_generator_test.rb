...
class PdfGeneratorTest < ApplicationSystemTestCase
  ...
  test "invoice displays all required information for PDF" do
    ...
    within ".invoice-content" do
      ...
      # Date might be formatted differently (e.g., "January 15, 2025")
      # Just check that some form of the date appears
      assert page.has_text?(@invoice.invoice_date.year.to_s), "Should show invoice year"
