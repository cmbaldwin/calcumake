Mobility.configure do
  ...
  plugins do
    ...
    #
    # Using table backend for better performance with rich text content
    #
    backend :table
    ...
    # Fallbacks
    #
    # Enable fallbacks to English for all locales
    # This ensures content displays even if translation is missing
    fallbacks({ ja: :en, "zh-CN": :en, hi: :en, es: :en, fr: :en, ar: :en })
